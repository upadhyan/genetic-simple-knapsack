...
```{r}
for(b in 1:6){
  baseline_name <- paste0('./a_baseline_output/baseline_test_results_','_',b,'.csv')
  
}


file_name = "knapsack_csv/knapPI_11_100_1000_2_900_3990_0.csv"
all_in_one_test(file_name, .08,.51, 100)
```
...
rand_soln_generation("./a_baseline_output/baseline_test_results_1.csv",
                   "./a_baseline_output/baseline_test_results_2.csv",
                   "./a_baseline_output/baseline_test_results_3.csv",
                   "./a_baseline_output/baseline_test_results_4.csv",
                   "./a_baseline_output/baseline_test_results_5.csv",
                   "./a_baseline_output/baseline_test_results_6.csv",
                   "./a_all_in_one_output/all_in_one_test_results_1.csv",
                   "./a_all_in_one_output/all_in_one_test_results_2.csv",
                   "./a_all_in_one_output/all_in_one_test_results_3.csv",
                   "./a_all_in_one_output/all_in_one_test_results_4.csv",
                   "./a_all_in_one_output/all_in_one_test_results_5.csv",
                   "./a_all_in_one_output/all_in_one_test_results_6.csv")
